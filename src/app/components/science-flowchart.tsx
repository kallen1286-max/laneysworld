      ...
      <div className="hidden lg:block space-y-4">
        ...
        <div className="flex items-stretch justify-center gap-2">
          ...
          <div className="flex items-center justify-center">
            <ArrowRight className="h-6 w-6 text-gray-400 dark:text-[#64748B]" aria-hidden="true" />
          </div>
        ...
        <div className="flex items-center justify-center py-1">
          <ArrowDown className="h-6 w-6 text-gray-400 dark:text-[#64748B]" aria-hidden="true" />
        </div>
        ...
        {[
          ...
          return (
            <div key={step.num}>
              ...
              {idx < 3 && (
                <div className="flex items-center justify-center py-1">
                  <ArrowDown className="h-5 w-5 text-gray-400 dark:text-[#64748B]" aria-hidden="true" />
                </div>
              )}
            </div>
          );
